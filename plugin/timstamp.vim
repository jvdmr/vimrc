...
" Last Change: Sat Jun 14 2008 20:52:07 CEST
" Timestamp: <timstamp.vim Sat 2008/06/14 20:52:07 jovdmeer sphinx.local>
...
let s:timstamp_3 = s:getValue('^\( *\(D\|d\)ate *\(:\|=\)\).*$'
	\ . '!\1 "%d %b %Y - %H:%M:%S"', "g:timstamp_3")
